...
package local_project.free_wifi_0_1;
...
/**
 * Job: Free_Wifi Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.0.20170510_1410
 * @status DEV
 */
public class Free_Wifi implements TalendJob {
	...
	private final String jobName = "Free_Wifi";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Free_Wifi.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.InputStream retIS_tFileFetch_1 = null;
	...
	client_tFileFetch_1.getParams().setCookiePolicy(org.apache.commons.httpclient.cookie.CookiePolicy.DEFAULT);
		...
		org.apache.commons.httpclient.methods.PostMethod method_tFileFetch_1 = new org.apache.commons.httpclient.methods.PostMethod("https://open.nrw/profiles/nrw_ressort/themes/custom/nrw_base/opendatafiles/Geb%C3%A4udeliste%20100%20x%20WLAN%20Stand%2025.08.2016.csv");
		...
		method_tFileFetch_1.setRequestEntity(new org.apache.commons.httpclient.methods.multipart.MultipartRequestEntity(parts_tFileFetch_1, method_tFileFetch_1.getParams()));          
	
	boolean isContinue_tFileFetch_1 = true;
	int status_tFileFetch_1;
	String finalURL_tFileFetch_1 = "https://open.nrw/profiles/nrw_ressort/themes/custom/nrw_base/opendatafiles/Geb%C3%A4udeliste%20100%20x%20WLAN%20Stand%2025.08.2016.csv";
	...
	if (isContinue_tFileFetch_1) {    
			...
			String sDir_tFileFetch_1 = (".").trim();
			String fileName_tFileFetch_1 = ("free.csv").trim();    
			//open directory
...
public static class MappedJsonStruct implements routines.system.IPersistableRow<MappedJsonStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_Free_Wifi = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_Free_Wifi = new byte[0];
			    ...
			    public String aktuelleGebaudenutzung;

				public String getAktuelleGebaudenutzung () {
					return this.aktuelleGebaudenutzung;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_Free_Wifi.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_Free_Wifi.length == 0) {
   					commonByteArray_LOCAL_PROJECT_Free_Wifi = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_Free_Wifi = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_Free_Wifi, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_Free_Wifi, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_Free_Wifi) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Strasse = readString(dis);
					
					this.aktuelleGebaudenutzung = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Strasse,dos);
					
					// String
				
						writeString(this.aktuelleGebaudenutzung,dos);
    ...
    public String toString() {
		...
		sb.append(",aktuelleGebaudenutzung="+aktuelleGebaudenutzung);
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(MappedJsonStruct other) {
...
public static class WifiInputFileStruct implements routines.system.IPersistableRow<WifiInputFileStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_Free_Wifi = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_Free_Wifi = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(WifiInputFileStruct other) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		WifiInputFileStruct WifiInputFile = new WifiInputFileStruct();
MappedJsonStruct MappedJson = new MappedJsonStruct();
	...
	currentComponent="tFileOutputJSON_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("MappedJson" + iterateId, 0, 0);
...
java.io.File file_tFileOutputJSON_1 = new java.io.File("./converted_data.json");
...
java.io.PrintWriter outtFileOutputJSON_1 = new java.io.PrintWriter(new java.io.BufferedWriter(new java.io.FileWriter("./converted_data.json")));
	...
	currentComponent="tMap_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("WifiInputFile" + iterateId, 0, 0);
...
MappedJsonStruct MappedJson_tmp = new MappedJsonStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "./free.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("./free.csv", "ISO-8859-15",";","\n",true,1,0,-1,-1, false);
						} catch(java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1!=null && fid_tFileInputDelimited_1.nextRecord()) {
						rowstate_tFileInputDelimited_1.reset();
									...
									WifiInputFile = new WifiInputFileStruct();
									try {
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							WifiInputFile.PLZ = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 1;
					
							WifiInputFile.Ort = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							WifiInputFile.Strasse = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							WifiInputFile.aktuelleGebaudenutzung = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
 ...
 */
// Start of branch "WifiInputFile"
if(WifiInputFile != null) { 
	...
	currentComponent="tMap_1";
			...
			//WifiInputFile
				...
				if(execStat){
					runStat.updateStatOnConnection("WifiInputFile"+iterateId,1, 1);
				} 
...
// # Output table : 'MappedJson'
MappedJson_tmp.PLZ = WifiInputFile.PLZ;
MappedJson_tmp.Ort = WifiInputFile.Ort;
MappedJson_tmp.Strasse = WifiInputFile.Strasse;
MappedJson_tmp.aktuelleGebaudenutzung = WifiInputFile.aktuelleGebaudenutzung;
MappedJson = MappedJson_tmp;
// ###############################
...
if(MappedJson != null) { 
	...
	currentComponent="tFileOutputJSON_1";
			...
			//MappedJson
				...
				if(execStat){
					runStat.updateStatOnConnection("MappedJson"+iterateId,1, 1);
				} 
...
org.json.simple.JSONObject jsonRowtFileOutputJSON_1 = new org.json.simple.JSONObject();
			    	if(MappedJson.PLZ != null){
			    
					jsonRowtFileOutputJSON_1.put("PLZ", MappedJson.PLZ);
				
					}else{
						jsonRowtFileOutputJSON_1.put("PLZ", null);
					}
				
			    	if(MappedJson.Ort != null){
			    
					jsonRowtFileOutputJSON_1.put("Ort", MappedJson.Ort);
				
					}else{
						jsonRowtFileOutputJSON_1.put("Ort", null);
					}
				
			    	if(MappedJson.Strasse != null){
			    
					jsonRowtFileOutputJSON_1.put("Strasse", MappedJson.Strasse);
				
					}else{
						jsonRowtFileOutputJSON_1.put("Strasse", null);
					}
				
			    	if(MappedJson.aktuelleGebaudenutzung != null){
			    
					jsonRowtFileOutputJSON_1.put("aktuelleGebaudenutzung", MappedJson.aktuelleGebaudenutzung);
				
					}else{
						jsonRowtFileOutputJSON_1.put("aktuelleGebaudenutzung", null);
					}
 ...
 */
...
} // End of branch "MappedJson"





} // End of branch "WifiInputFile"
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("./free.csv") instanceof java.io.InputStream)){
...
// ###############################      
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("WifiInputFile"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tFileOutputJSON_1_NB_LINE",nb_line_tFileOutputJSON_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("MappedJson"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final Free_Wifi Free_WifiClass = new Free_Wifi();

        int exitCode = Free_WifiClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Free_Wifi.class.getClassLoader().getResourceAsStream("local_project/free_wifi_0_1/contexts/"+contextStr+".properties");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Free_Wifi");
        }
...
/************************************************************************************************
 *     47130 characters generated by Talend Open Studio for Data Integration 
 *     on the May 16, 2017 10:02:16 PM CEST
 ************************************************************************************************/